...
radian-parse-csv-mark is a Ruby project for parsers. It focuses on this technical goal: Implement a Ruby parsers project for csv graph analysis, using node-edge fixtures and cycle and reachability reports.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 167, risk penalty 5, latency penalty 3, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
